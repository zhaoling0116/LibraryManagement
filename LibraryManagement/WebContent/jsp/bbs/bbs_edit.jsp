...
<html>
		...
		<div class="container">
			...
			<input type="hidden" name="id" value="${bbs.id }">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input  class="form-control" name="content" value="${bbs.content }"  placeholder="输入内容"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							<input type="text" class="form-control" id="mydate" name="intime"  value="<fmt:formatDate value="${bbs.intime }" pattern="yyyy-MM-dd"/>" placeholder="点击选择时间"/>
	...
	<script type="text/javascript">
		function btn_save(){
			document.form1.action = "<%=request.getContextPath()%>/bbs/editsave.action";
